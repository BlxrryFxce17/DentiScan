    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          CategoryCard(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(record.chiefComplaint, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppTheme.slate900)),
                if (record.clinicalDiagnosis != null && record.clinicalDiagnosis!.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 4),
                  Text(record.clinicalDiagnosis!, style: const TextStyle(fontSize: 13, color: AppTheme.slate800)),
                ],
              ],
            ),
          ),
          ...
          // Procedures Table
          CategoryCard(
            title: 'Procedures & Tooth Details (${record.toothProcedures.length})',
            subtitle: 'Targeted dental interventions',
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: record.medicalHistory.isNotEmpty
                      ...
                      : [const Text('No significant medical history', style: TextStyle(fontSize: 12, color: AppTheme.slate400))],
                ),
                const SizedBox(height: 12),
                ...
                Wrap(
                  ...
                  children: record.dentalHistory.isNotEmpty
                      ...
                      : [const Text('None reported', style: TextStyle(fontSize: 12, color: AppTheme.slate400))],
                ),
              ],
            ),
          ),
          ...
          CategoryCard(
            ...
            subtitle: 'Estimated fees, insurance and balance',
